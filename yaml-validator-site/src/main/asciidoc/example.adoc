...
Instead, it's a notation in YAML indicating the following word is a tag, thus `!gt` means **greater than**, instead of **not greater than**, i.e. less than or equal to.
